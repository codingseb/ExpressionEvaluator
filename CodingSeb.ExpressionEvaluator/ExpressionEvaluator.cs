...
namespace CodingSeb.ExpressionEvaluator
{
    ...
    public partial class ExpressionEvaluator
    {
        ...
        //language=regex
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Style", "RE0001:Regex issue: {0}", Justification = "<Pending>")]
        ...
        #region Options base abstract class
        ...
        public class SyntaxRules : Options
        {
            ...
            /// <para>Default value : <c>{"new"}</c></para>
            /// </summary>
            public string[] KeywordNew
            {
                get { return keywordNew; }
                set
                {
                    keywordNew = value;
                    evaluator?.RefreshInstanceCreationKeywordRegexPattern();
        ...
        /// <para>Warning if using comma in separators change also OptionFunctionArgumentsSeparator and OptionInitializersSeparator otherwise it will create conflicts</para>
        /// </summary>
        ...
        protected virtual void OptionsInit()
        {
        ...
        protected virtual bool EvaluateInstanceCreation(string expression, Stack<object> stack, ref int i)
        {
            ...
            if (instanceCreationMatch.Success
                ...
                || stack.Peek() is ExpressionOperator))
            {
                void InitSimpleObject(object element, List<string> initArgs)
                {
        ...
        protected virtual bool EvaluateIndexing(string expression, Stack<object> stack, ref int i)
        {
            ...
            if (indexingBeginningMatch.Success)
            {
                ...
                List<string> indexingArgs = GetExpressionsBetweenParenthesesOrOtherImbricableBrackets(expression, ref i, true, startToken: "[", endToken: "]");
