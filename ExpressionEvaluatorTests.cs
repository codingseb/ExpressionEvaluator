...
public class ExpressionEvaluatorTests
{
    ...
    [TestCase("-63d", typeof(double), Category = "DoubleFormats")]
    [TestCase("123.54d", typeof(double), Category = "DoubleFormats")]
    [TestCase("-146.678d", typeof(double), Category = "DoubleFormats")]
